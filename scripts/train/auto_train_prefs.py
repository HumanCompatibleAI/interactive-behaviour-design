...
def main():
    ...
    if args.segment_generation == 'drlhp':
        ...
        wait_for_demonstration_rollouts(base_url)
        wait_for_drlhp_segments(base_url)
        start_oracle(base_url, 'drlhp', args.tmux_sess, args.log_dir, args.min_label_interval_seconds, args.oracle_args)
        start_oracle(base_url, 'demonstrations', args.tmux_sess, args.log_dir, args.min_label_interval_seconds, args.oracle_args)
        wait_for_initial_demonstrations(base_url, args.n_initial_demos)
        start_reward_predictor_training(base_url, args.pretrain_reward_predictor_seconds)
...
def start_oracle(base_url, segment_generation, tmux_sess, log_dir, min_label_interval_seconds, oracle_args):
    if segment_generation == 'sdrlhp':
