...
def main():
    ...
    if args.segment_generation == 'drlhp':
        ...
        start_reward_predictor_training_and_pretrain(base_url, args.pretrain_reward_predictor_seconds)
